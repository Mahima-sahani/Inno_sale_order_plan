...
class ReportPrintFullLabel(models.AbstractModel):
    _name = 'report.inno_packaging.report_print_livabliss_label'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for record in records:
            ...
            if planning_id:
                planning_line = planning_id.sale_order_planning_lines.filtered(lambda pl: pl.product_id.id == record.quant_ids.product_id.id and pl.brand == "LIVABLISS")
                if planning_line:
